...
export function Table<T>({ columns, data, title, keyExtractor, className = '' }: TableProps<T>) {
            ...
            <div>
                {data.map((row) => (
                    <div
                        ...
                        className="grid grid-cols-12 gap-4 px-4 py-3 items-center border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors"
                    >
                        {columns.map((col, idx) => {
